...
public class PullToRefreshLayout extends RelativeLayout
{
    ...
    // 默认下拉头
    public View defaultRefreshView;
    // 下拉的箭头
    ...
    // 默认上拉头
    public View defaultLoadmoreView;
    // // 上拉的箭头
...
//            new RemainHandler(this).sendEmptyMessageDelayed(0, 1);
