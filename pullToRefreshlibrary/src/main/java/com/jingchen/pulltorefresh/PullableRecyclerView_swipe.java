...
public class PullableRecyclerView_swipe extends SwipeMenuRecyclerView implements Pullable
{
    public int mFirstVisiblePosition = -1;
    public int mLastVisiblePosition = -1;

    public PullableRecyclerView_swipe(Context context)
    {
        this(context, null, 0);
    }

    public PullableRecyclerView_swipe(Context context, AttributeSet attrs)
    {
        this(context, attrs, 0);
    }

    public PullableRecyclerView_swipe(Context context, AttributeSet attrs, int defStyle)
    {
