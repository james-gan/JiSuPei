 ...
 */
public class VpCartsActivity extends BaseActivity {
    ...
    public void setLayoutContentView(Bundle savedInstanceState) {
        setContentView(R.layout.newvp_cart);
        ButterKnife.inject(this);
//        AutoUtils.auto(this);
        StatusBarUtil.setStatusBarColor(this,R.color.white);
        int a2=  StatusBarUtil.StatusBarLightMode(VpCartsActivity.this);
        if(a2==0){
            StatusBarUtil.setStatusBarColor(VpCartsActivity.this,R.color.black);
        }
        ...
        SwipeMenuCreator swipeMenuCreator = new SwipeMenuCreator() {
            ...
            public void onCreateMenu(SwipeMenu swipeLeftMenu, SwipeMenu swipeRightMenu, int viewType) {
                SwipeMenuItem deleteItem = new SwipeMenuItem(VpCartsActivity.this)
                        .setBackgroundColor(Color.parseColor("#ff671d"))
//                        .setImage(R.mipmap.add) // 图标。
                        .setText("删除") // 文字。
                        .setTextColor(Color.WHITE) // 文字颜色。
                        .setTextSize(16) // 文字大小。
                        .setWidth(AppUtils.dp2px(VpCartsActivity.this, 75))
                        .setHeight(AppUtils.dp2px(VpCartsActivity.this, 90));
...
//                ToasAlert.toastCenter(adapterPosition + "");
              ...
              if(empty.getVisibility()==View.VISIBLE){
                ...
                if(mAdapter!=null){
                    if(mAdapter.map.size()==0||mAdapter.map==null){
                        ...
                        Intent intent = new Intent(VpCartsActivity.this,VpNewConfirmNewActivity.class);
    ...
    public void queryCartNum(final PullToRefreshLayout pullToRefreshLayoutTemp) {
        try {
            try {
                mVpNewProductDbDaoDao = DatabaseHelper.getHelper(VpCartsActivity.this).getVpNewProductDbDaoDao();
            ...
            if (mProductList != null && mProductList.size() > 0) {
                ...
                AppLoading.show(VpCartsActivity.this);
                    ...
                    public void onResponse(String response, int id) {
                        ...
                        if ("yes".equals(optFlag)) {
                            ...
                            if (arrProduct.size() <= 0) {
                                ...
                                try {
                                    mVpNewProductDbDao = DatabaseHelper.getHelper(VpCartsActivity.this).getVpNewProductDbDaoDao();
...
//                            sumint_bt.setBackgroundColor(Color.parseColor("#999999"));
                            mAdapter = new MyAdapter(VpCartsActivity.this, arrProduct, MainActivity.HOME_EVENT);
                            LinearLayoutManager linearLayoutManager = new LinearLayoutManager(VpCartsActivity.this);
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            holder.jian.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    AddNewVpIndexSearchPop mPopupWindow = new AddNewVpIndexSearchPop(VpCartsActivity.this,dish);
