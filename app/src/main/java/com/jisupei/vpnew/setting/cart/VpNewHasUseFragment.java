 ...
 */
public class VpNewHasUseFragment extends BaseFragment {
    ...
    public static VpNewHasUseFragment getVpNewNotUseFragment() {

        VpNewHasUseFragment instance = new VpNewHasUseFragment();
        return instance;
    }
...
//                load(search_ed.getText().toString().trim(),pullToRefreshLayout);
  ...
  public   String  orderCode;
    ...
    public void loadDatanew(final PullToRefreshLayout pullToRefreshLayout) {
        ...
        HttpUtil.getInstance().getMyCouponAppY(new StringCallback() {
            @Override
...
//
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view=   LayoutInflater.from(context).inflate(R.layout.vp_cart_hasuse_adapter, null, false);
//        AutoUtils.auto(view);
