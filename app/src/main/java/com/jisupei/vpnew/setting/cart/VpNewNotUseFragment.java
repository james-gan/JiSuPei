 ...
 */
public class VpNewNotUseFragment extends BaseFragment {
    ...
    public static VpNewNotUseFragment getVpNewNotUseFragment() {

        VpNewNotUseFragment instance = new VpNewNotUseFragment();
        return instance;
    }
...
//
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view=   LayoutInflater.from(context).inflate(R.layout.vp_cart_notuse_adapter, null, false);
//        AutoUtils.auto(view);
