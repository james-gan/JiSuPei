 ...
 */
public class VpheadSoldAlreadyFragment extends BaseFragment {
    ...
    public static VpheadSoldAlreadyFragment getOrderFragmentInstance() {
        VpheadSoldAlreadyFragment instance = new VpheadSoldAlreadyFragment();
        return instance;
    }
...
//        });
    ...
    private void lodeOrder( String handleStatus,final int pagenoTemp, final int isPull) {
        ...
        HttpUtil.getInstance().productIndexH5Shouxin("","","",pagenoTemp ,new StringCallback() {
            @Override
