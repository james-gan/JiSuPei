 ...
 */
public class VpheadAlreadyShelvesFragment extends BaseFragment {
    ...
    public static VpheadAlreadyShelvesFragment getOrderFragmentInstance() {
        VpheadAlreadyShelvesFragment instance = new VpheadAlreadyShelvesFragment();
        return instance;
    }
...
//        });
    ...
    private void lodeOrder( String handleStatus,final int pagenoTemp, final int isPull) {
        ...
        HttpUtil.getInstance().productIndexH5("","N","",pagenoTemp ,new StringCallback() {
            @Override
